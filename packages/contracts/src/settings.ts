...
export const ClientSettingsSchema = Schema.Struct({
  ...
  showContextBar: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
  enableBackgroundNotifications: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
  smoothAnimations: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  showContextBar: Schema.optionalKey(Schema.Boolean),
  enableBackgroundNotifications: Schema.optionalKey(Schema.Boolean),
  smoothAnimations: Schema.optionalKey(Schema.Boolean),
